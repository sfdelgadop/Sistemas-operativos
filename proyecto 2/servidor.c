...
void hilo_cliente(){                                                //Función nueva
     pthread_mutex_t h1;
     pthread_mutex_t h2;
     pthread_t th1, th2, th3, th4;
     pthread_mutex_init(&h1, NULL);
     pthread_mutex_init(&h2, NULL);
     pthread_create(&th1, NULL, (void*)crear_registro, NULL);
     pthread_create(&th2, NULL, (void*)crear_registro, NULL);
     pthread_create(&th3, NULL, (void*)crear_registro, NULL);
     pthread_create(&th4, NULL, (void*)crear_registro, NULL);
...
int main () {
	...
	server.sin_port = htons(3536);//htons sirve para evitar en endian   ismo
	...
	while (client_exist == true){                                                   //Cambiado
        hilo_cliente();
	}
